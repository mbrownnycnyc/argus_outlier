...
def FindQuantile(data,findme):
    ...
    probset=[]
    #cheap hack to make a quick list to get quantiles for each percentage value]
    ...
    for quantile in quantiles:
        if (findme > quantile):
            ...
            print str(quantile) + ' is the quantile value for the ' + str(i) + '-' + str(i + 1) + ' 1/10000 quantile range. ' + str(findme) + ' falls within this range.'
            break
        i = i + 1
...
if __name__ == "__main__":
    ...
    print 'Connecting to ny-sentinel'
    db = MySQLdb.connect("ny-sentinel","argus","l1ght3st","argus" )
    print 'Connected... creating db cursor'
    cursor = db.cursor()
    sql = "SELECT dbytes FROM argus.argusTable_2013_06_24 where (saddr = '192.168.17.23' or daddr = '192.168.17.23') and daddr = '74.85.246.22' and proto = 'tcp' and dport = '443';"
